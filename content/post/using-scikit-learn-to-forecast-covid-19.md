...
lastmod = 2021-05-06T22:17:17+08:00
...
### <span class="org-todo todo TODO">TODO</span> 调整数据特征 {#调整数据特征}

改变 lag\_start/end 的范围，使用不同的特征。


### <span class="org-todo todo TODO">TODO</span> 调整模型参数 {#调整模型参数}

改变模型的参数组合，或者将不同的模型做组合预测。
