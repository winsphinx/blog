...
lastmod = 2024-12-14T08:49:47+08:00
tags = ["linux", "Windows"]
categories = ["技术"]
draft = false
+++

秋去冬来，又到了上级部门检查组出没的季节。由于要检查各种系统日志的备份记录，就得无中生有给变出来。按照要求是每天一个文件夹，里面是当天的日志。如果手工复制文件再修改日期，肯定得累死。于是在 linux 和 windows 的电脑上分别用 bash 和 powershell 编了脚本来实现。 <br/>
