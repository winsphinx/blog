...
lastmod = 2024-11-20T15:18:52+08:00
tags = ["linux", "Windows"]
categories = ["技术"]
draft = false
+++

年底将至，又到了上级部门检查组出没的季节。由于要检查各种系统日志的备份记录，就得无中生有给变出来。按照要求是每天一个文件夹，里面是当天的日志。如果手工复制文件再修改日期，肯定累死。于是在 linux 和 windows 的电脑上分别用 bash 和 powershell 编了脚本来实现。 <br/>
